...
export default function CaseStudyCard({ children, delay }: Props) {
  return (
    <ShowUp transition={{ duration: 0.5, delay: delay }} className='h-[200px] lg:h-1/2 w-5/6 lg:w-[30%] px-5 lg:px-0 py-3 bg-secondary lg:bg-transparent shrink-0 snap-center lg:snap-none rounded-2xl lg:rounded-none'>
