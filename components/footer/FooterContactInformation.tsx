...
export default function FooterContactInformation() {
    return (
        <div className='w-full lg:w-2/5 h-fit flex items-center md:items-start flex-col gap-5'>
            <SectionHeading.Title title='Contact us:' className='text-xl text-secondary' />
            <ul className='flex text-center md:text-start flex-col gap-5 text-white'>
