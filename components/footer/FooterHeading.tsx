...
function FooterHeading() {
    return (
        <section className='h-full flex flex-col md:flex-row justify-evenly md:justify-between items-center'>
            <span className='size-fit' >
                <Logo color='white' />
            </span>
            <ul className='flex flex-col md:flex-row items-center md:items-start gap-3 lg:gap-10 justify-center w-3/5' >
